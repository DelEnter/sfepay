...
<script type="text/javascript" src="https://security.sslepay.com/js/cardholders3.js"></script>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="106" valign="top" background=""><img src="https://www.ecpss.com/jsp/ibank/images/123_r1_c1.jpg" alt="" width="800" border="0" usemap="#Map"></td>
  </tr>
</table>
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
          ...
          <tr>
            ...
            <td width="558" align="center" valign="top" bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <table width="96%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="kuang1">
                <tr>
                  <td width="130" height="30" align="left" valign="middle"><table width="92%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
...
cvv2<font color="red"><img src="https://www.ecpss.com/jsp/ibank/images/index_888.gif"/> * </font> </label></td>
                ...
                <tr>
                  ...
                  <td align="left" valign="middle" class="zi4">MM<s:select name="month" id="month" headerKey="" headerValue="--" list="#@java.util.TreeMap@{'01':'01','02':'02','03':'03','04':'04','05':'05','06':'06','07':'07','08':'08','09':'09','10':'10','11':'11','12':'12'}" onchange="checkdate()"></s:select>
                    /
                    YY<s:select name="year" id="year" headerKey="" headerValue="--" list="#@java.util.TreeMap@{'09':'09','10':'10','11':'11','12':'12','13':'13','14':'14','15':'15','16':'16','17':'17','18':'18','19':'19'}" onchange="checkdate()"></s:select>
      <font color="red"> * </font></td>
              ...
              <table width="96%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="kuang1">
                <tr>
                  <td height="30" align="left" valign="middle" class="zi4"><span class="STYLE19"><s:text name="first_name"/>: </span></td>
                ...
                <tr>
                  <td height="30" align="left" valign="middle" class="zi4"><s:text name="last_name"/>:</td>
