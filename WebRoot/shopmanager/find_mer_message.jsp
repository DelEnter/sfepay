    	...
    	<s:form action="ShowMerMessage" method="post" theme="simple">
	    	...
	    	<table  border="0" cellspacing="5"  cellpadding="0">
	    		...
	    		<tr>
	    			...
	    			<td>
	    				<s:property value="mer.openTime"/>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td class="font_14px">年费</td>
	    			<td>
	    				<s:property value="mer.annualFee"/>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td class="font_14px">备注</td>
	    			<td>
	    				<s:property value="mer.remark"/>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td class="font_14px">开通状态</td>
	    			<td>
	    				<s:if test="mer.expopenstatus == 1">
	    					已开通
	    				</s:if>
	    				<s:if test="mer.expopenstatus == 0">
	    					未开通
	    				</s:if>	    					
	    			</td>
	    		</tr>	
	    		<tr>
	    			<td class="font_14px">物流折扣</td>
	    			<td>
	    				<s:property value="mer.discountfee"/>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td class="font_14px">蜂皇用户名</td>
	    			<td>
	    				<s:property value="mer.expuername"/>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td class="font_14px">蜂皇密码</td>
	    			<td>
	    				<s:property value="mer.exppassword"/>
	    			</td>
	    		</tr>	    			    			    			
	    	</table>
