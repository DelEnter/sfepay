...
<TABLE cellSpacing="0" cellPadding="0" align="center" border=1 width="100%">
	...
	<tr onMouseOver="this.bgColor='#BBBBFF'; "  onMouseOut="this.bgColor='#FFFFFF';">
		...
		<td align="center"><s:property value="states.getStateName(#p[1].tradeState,1)"/></td>
		<td align="center"><s:property value="states.getRefundDetailState(#p[0].refundState)"/></td>
