...
//-->
	...
	<body>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
             <td style="text-align: center;background:url(images/other/login_bg.gif);height: 537px;">
              <form action="loginSys.action" method="post" id="myform" onSubmit="return checkAll()">
			  <table style="margin: 0 auto;">
	              <tr>
	              	<td colspan="2"><span style="color:red"><s:property value="messageAction"/></span></td>
	              </tr>
	              ...
	              <tr>
	                <td height="30">&nbsp;&nbsp;</td>
	                <td height="30"><input type="submit" value="提交" class="windows_icon1" onClick="tijiao()"></td>
	              </tr>
