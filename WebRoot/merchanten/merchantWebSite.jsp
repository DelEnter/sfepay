...
<s:action name="indexMenuEn" executeResult="true"/>  
    ...
    <div class="mainbody">
	   <div class="list">
	      ...
	      <div class="listtitle">
           <ul class="top">
             <li class="lifonttitle">Merchant Website</li>
             <li class="lilistother"></li>
            
           </ul>
          <ul class="bottom">
          <li class="li_02">Serial No.</li>  
		       <li class="li_02">Website</li>  
		       <li class="li_02">Transaction Website</li>    
             </ul>
         </div>
		  ...
		  <div class="listlist">
		    <s:iterator id="website" value="internationalWebchannelsList"  status="s">
               ...
               <li class="lil_02"><s:property value="#s.index" /></li>
