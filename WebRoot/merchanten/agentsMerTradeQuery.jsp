...
<input type="hidden" name="isdownload" value=""/>
    <div class="mainbody">
       <div class="search">
         <ul class="searchtext">
       ...
       <div class="list">
         <div class="listtitle">
           <ul class="top">
            ...
            <s:iterator id="a" value="amountStatistic" status="s">
             ...
             <li class="lilistimg"><input type="image" src="images/download.gif" alt="DownLoad" onclick="exportInfo()" /></li>
           </ul>
           <ul class="bottom">
             ...
             <li class="li_05">Refund</li>  
             <li class="li_03">ChargeBack</li>  
             <li class="li_03">Settlement</li>  
        ...
        <s:iterator id="m" value="info.result" status="s">
           ...
           <ul class="listlistbottom">
             ...
             <li class="lil_05"><s:property value="states.getStateNameEn(#m[0].tradeState,2)" escape="false"/></li>    
             <li class="lil_03"><s:property value="states.getStateNameEn(#m[0].tradeState,3)" escape="false"/></li>    
             <li class="lil_03"><s:property value="states.getStateNameEn(#m[0].tradeState,8)" escape="false"/></li>    
