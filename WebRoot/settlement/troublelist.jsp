...
<html>
  ...
  <body>
  	...
  	<s:form id="form1" action="toTroubleList" theme="simple" method="post">
  		<table align="center">
  			<tr>
  				<td>商户号</td>
  				<td>
  	...
  	<s:form action="toTroubleList" id="form2" name="form2" theme="simple" method="post">
...
<pages:pages value="info" beanName="info" formName="getElementById('form2')" />  	
   		<table align="center">
   			<tr>
   			<td valign="top">
  		  <textarea id="links" rows="21" cols="20" /><s:property value='#trackingno'/></textarea>
  		    <input type="button" value="复制跟踪单号" onClick="javascript:copyToClipboard('links',true);"/> </td>
    			<td>
    					
    				<input type="button" value="审单通过" onClick="check()"/>
    			</td>
    			<td>
    				<s:reset value="取消"/>
    			</td>
