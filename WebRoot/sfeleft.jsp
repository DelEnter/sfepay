        ...
        <form name="form2" id="form2" action="" method="post" onsubmit="return checkHolderInfo()">
          ...
          <p>
            ...
            <input type="text" name="vercode" id="vercode" size="9" class="lgom" autocomplete="off" />
             ...
             <img style="line-height:23px; margin-left:9px;" src="authImg.do" id="authImg" alt="点击刷新" /></a>
            </p>
          <p>
            <input type="button" name="sub" id="sub" value="登录" class="insub" onclick="submitInfo('merchant/merLogin.action','login')" />
          <a href="newReg.jsp" target="_blank" id="butjoin"> <img src="images/join-but.jpg" style="line-height:24px; margin-left:37px;margin-top:5px;float:left;height:21px;width:53px;" /></a> </p>
        </form>
      </div>
      <div class="le_help">
        <ul>
