       ...
       <div class="list">
         <div class="listtitle">
          ...
          <li class="lilistimg"><a href="#" onclick="exportInfo()"><img src="images/download.gif" alt="下载交易" /></a></a></li>
           ...
           <ul class="bottom">
			 ...
			 <s:if test="#session.merchantBean.merChantNo=='4087'||#session.merchantBean.merChantNo=='4132'">
             <li class="li_04">退款流水号<input type="hidden" name="exportOrNo" value="1"/></li>  
             </s:if>
         ...
         <s:iterator id="p" value="info.result" status="s">
           <ul class="listlistbottom">
                ...
                <li class="lil_10"><s:property value="#p[1].orderNo" /></li> 
				...
				<s:if test="#session.merchantBean.merChantNo=='4087'||#session.merchantBean.merChantNo=='4132'">
				<li class="lil_04"><s:property value="#p[0].refundNo" /></li> 
				</s:if>
				<li class="lil_01">
