...
<body onload="setTimeout('submit()',5000)">
	<form name="form1" action="http://sslepay.viigoo.com/paymentsuccess.jsp" method="post"> 
		<table align="center">
		    ...
		    <tr>	   
		        <td align="left">
		        <input type="hidden" name="PaymentOrderNo" value="<s:property value="rorderno"/>">
		        <input type="hidden" name="BillNo" value="<s:property value="merchantOrderNo"/>">
		        	...
		        	<input type="hidden" name="ReturnURL" value="<s:property value="ReturnURL"/>">
