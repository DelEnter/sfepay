	...
	<form name="form1" action="<s:property value="ReturnURL"/>" method="post"> 
		<table align="center">
		    ...
		    <tr>	   
		        ...
		        <input type="hidden" name="MerNo" value="<s:property value="merchantno"/>">
		        	<input type="hidden" name="BillNo" value="<s:property value="merchantOrderNo"/>">
		        	...
		        	<input type="hidden" name="authorizationNo" value="<s:property value="authno"/>">
		        	<input type="hidden" name="batchno" value="<s:property value="batchno"/>">
		        	<input type="hidden" name="datetime" value="<s:property value="datetime"/>">
