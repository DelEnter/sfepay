...
<div class="container">
   <div class="header2">
     ...
     <div class="welcome">
       <div class="help">
         <ul>
           <li><img src="images/icon_01.gif" alt="帮助中心" />&nbsp;<a target=blank href=tencent://message/?uin=2426354956&Site=2426354956&Menu=yes>技术支持</a></li>
           <li><img src="images/icon_02.gif" alt="在线客服" />&nbsp;<a target=blank href=tencent://message/?uin=2248884917&Site=2248884917&Menu=yes>在线客服</a></li>
         </ul>
       </div>
     ...
     <!--<div class="affiche">
       <span><b>公告：</b><font class="font_color_01">总经理邮箱:complaints@ecpss.com.广大商户如有任何建议可发送邮件到此邮箱.</font></span>
     </div>-->
     
     <div class="container1">
        <div id="header1m">
        <ul class="topnav">
            <li><a href="goHome.action">首页</a></li>
            <li>
                <a href="#">交易管理</a>
                <ul class="subnav">
