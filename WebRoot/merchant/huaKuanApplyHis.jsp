...
<s:form name="form2" action="applyMerSettlement" method="post" theme="simple">
    <div class="mainbody">
       ...
       <div class="list">
         <div class="listtitle">
           <ul class="top">
             <li class="lifonttitle">提交划款申请历史</li>
             <li class="lilistimg"></li>
           </ul>
           <ul class="bottom">       
	       <li class="li_05">交易金额</li> 
	       <li class="li_05">状态</li>   
         ...
         <div class="listlist">
         <s:set name="samount" value="0"/>
         <s:iterator id="gouDuiList" value="tradeList">
         <ul class="listlisttop">
     		 <li>订单号：<s:property value="#gouDuiList.merchantOrderNo"/></li>
      		 <li>交易日期：<s:property value="#gouDuiList.tradeTime"/></li>
    		</ul>
    		<ul class="listlistbottom">

      		 <li class="lil_05"><s:property value="#gouDuiList.tradeAmount"/></li> 
      		 <s:set name="samount" value="#samount+#gouDuiList.tradeAmount"/>   
     		 <li class="lil_05">
     		 <s:property value="states.getStateName(#gouDuiList.tradeState,1)"  escape="false"/>	
              </li>   
     		 <li class="lil_04">
     		 <s:if test="#gouDuiList.tradeState.substring(1,2)==2">
 		 	 ...
 		 	 <s:else>
                  <s:property value="states.getStateName(#gouDuiList.tradeState,2)"  escape="false"/>		
          	</s:else>
              </li>   
      		 <li class="lil_04">
      		 <s:property value="states.getStateName(#gouDuiList.tradeState,4)"  escape="false"/>		
              </li>    
     		 <li class="lil_04">
     		 <s:property value="states.getStateName(#gouDuiList.tradeState,3)"  escape="false"/>		
              </li>    
     		 <li class="lil_04">
     		 <s:property value="states.getStateName(#gouDuiList.tradeState,5)"  escape="false"/>		
              </li>    
    		     <li class="lil_05">
	   ...
	   <font color="red">  总计： <s:property value="#samount"/></font>
