...
<html>
  <head>
    ...
    <title>查看保证金划款表</title>
   	<LINK href="../css/head.css" type=text/css rel=stylesheet>
  </head>
  
  <body>
  	<center>
  		<h3 align="center" style=" font-size:24px; color:#000000; background:#ffffff">查看保证金划款表</h3>
	    <TABLE borderColor=#ffffff cellSpacing=0 cellPadding=0 width="900" align=center 
	    	...
	    	<tr>
	    		...
	    		<td colSpan=10>
	    			<s:property value="bailhua.tradestarttime"/>&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="bailhua.tradeendtime"/>
	    		</td>
	    	</tr>
	    	<tr>
	    		<th rowSpan=4>收款人</th>
