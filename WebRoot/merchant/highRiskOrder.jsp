...
<!--头部end-->
<s:form name="formu" id="formu" action="highRiskOrder" method="post" theme="simple">
    ...
    <div class="mainbody">
       ...
       <div class="list">
         <div class="listtitle">
           ...
           <ul class="bottom">
             <li class="li_10">流水订单号</li>
             <li class="li_10">商户订单号</li>
             <li class="li_06">金额</li>
			 <li class="li_08">交易网址</li>
        ...
        <s:iterator id="m" value="info.result" status="s">
		           <ul class="listlistbottom">
		             <li class="lil_10"><a href="#" style="color:#000; text-decoration:underline" onclick="detialinfo(<s:property value="#m[6]"/>)"><s:property value="#m[0]" /></a></li>
		             <li class="lil_10"><s:property value="#m[1]"/></li>
		             <li class="lil_06"><s:property value="#m[3]"/></li>
					 <li class="lil_08"><s:property value="#m[7]"/></li>
