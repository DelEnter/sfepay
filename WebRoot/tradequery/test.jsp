...
<script type="text/javascript" src="../js/trade_statistics_charts.js"></script>
...
<script type="text/javascript">
	<c:if test="${not empty jsonTradeSecondList }">
		var data = ${jsonTradeSecondList};
	</c:if>
	<c:if test="${empty jsonTradeSecondList }">
		var data = [];
	</c:if>
</script>
