...
<html>
  <head>
	...
	function addCourse(f) {
		goFormWindow(f,"../PaySystem/addMerchantWebSite1.action");
	}
	
	//表单项不能为空
	function checkIsNull(name,value,sign) {
		...
		bgColor=#ffffff borderColorLight=#000000 border=1 height="10">
			<tr>
		    	...
		    	<tr>
		    		<td>交易网址</td>
		    		<td>
		    			<s:textfield name="website.tradeWebsite" id="tradeWebsite" onblur="checkIsNull('交易网址',this.value,'tradeWebsite');"></s:textfield>
		    		</td>
		    	</tr>
		    	<tr>
		    		<td>返回网址</td>
		    		<td>
		    		<s:textfield name="website.website" id="website" onblur="checkIsNull('网址',this.value,'website');"></s:textfield>
		    		</td>
		    	</tr>
		    </table>
