...
<script language="JavaScript" src="../js/util.js"></script>	
	...
	function add(){ 
	   ...
	   openWindow('../PaySystem/toAddMerchantWebSite.action?merid='+merid,'12')
	}
	
	//修改网址
	function update(id){
		openWindow('../PaySystem/toUpdateMerchantWebSite.action?iid='+id,'12')
	}
	</script>
</head>
	...
	bgColor=#ffffff borderColorLight=#000000 border=1 height="10" >
    		...
    		<s:iterator id="merchantWebSiteList" value="merchantWebSiteList" >
	    		<tr>
	    			...
	    			<td><s:property value="#merchantWebSiteList[0].remark"/>&nbsp;</td>
	    			<td>
