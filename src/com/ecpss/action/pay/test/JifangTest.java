...
//		String Transation_Local="";
		String Exp="1008";//有效期
		String cardno="5432674008946591";//卡号
		String cvv2="998";
		String orderNo="000100";//流水号	
		String batchNo="";//38
		String RETRIEVAL_REFERENCE_NUMBER="";//37
		//0800
...
//    	 batchNo=msg2.getAUTH_IDENTIFICATION_RESPONSE();
//    	System.out.println("batchNo="+msg2.getAUTH_IDENTIFICATION_RESPONSE());
//    	RETRIEVAL_REFERENCE_NUMBER=msg2.getRETRIEVAL_REFERENCE_NUMBER();
//    	System.out.println("RETRIEVAL_REFERENCE_NUMBER====:"+RETRIEVAL_REFERENCE_NUMBER);
//     	 }
//     	 else 
     		 if(dcc.getRESPONSE_CODE().equals("YY")){
...
//       	 msg3.setRETRIEVAL_REFERENCE_NUMBER("");//37
        	...
        	RETRIEVAL_REFERENCE_NUMBER=msg3.getRETRIEVAL_REFERENCE_NUMBER();
       	 batchNo=msg3.getAUTH_IDENTIFICATION_RESPONSE();
...
//       	 msg4.setRETRIEVAL_REFERENCE_NUMBER(RETRIEVAL_REFERENCE_NUMBER);//37
//       	 msg4.setAUTH_IDENTIFICATION_RESPONSE(batchNo);//38
...
//          	 msg5.setAmount_Transaction_Foreign(dcc.getAmount_Transaction_Foreign());//5  0810
           	 ...
           	 msg5.setAUTH_IDENTIFICATION_RESPONSE(batchNo);//38
     	 ...
     	 if(dcc.getRESPONSE_CODE().equals("YX")){
         	 DCCMessage msg6=new DCCMessage();
           	 ...
           	 msg6.setProcessing_Code("020000");//处理代码3
           	 ...
           	 msg6.setRETRIEVAL_REFERENCE_NUMBER(RETRIEVAL_REFERENCE_NUMBER);//37
     	 ...
     	 }else if(dcc.getRESPONSE_CODE().equals("YY")){
...
//           	 msg7.setConversion_Rate(dcc.getConversion_Rate());//9    0810
           	 ...
           	 msg7.setRETRIEVAL_REFERENCE_NUMBER(RETRIEVAL_REFERENCE_NUMBER);//37
