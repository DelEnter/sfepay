...
public class InternationalHuakuan implements java.io.Serializable {
	...
	/** default constructor */
	public InternationalHuakuan() {
	}

	/** minimal constructor */
	public InternationalHuakuan(Long id) {
		this.id = id;
	}
	...
	public Double getBalancemoney() {
		return  ( this.getTradeMoneyAll()
				-this.getNoTuiKuanMoney()
				-this.getNoTuiKuanMoneyall()
				-this.getTuiKuanMoney()
				-this.getTuiKuanMoneyall()
				-this.getFreezeMoney()
				//+this.getThawMoney()+this.refuceMoney+this.getRefuceComplementMoney()
				+this.getThawMoney()
				-this.getNoProtestMoney()
				-this.getProtestMoney()
				-this.getBailmoney()
				-this.getProcedureFee());
	}
	...
	public Double getProtestFee(){	
		if(dishonor!= null){
			return Double.valueOf((this.protestNumber+this.noProtestNumber)*dishonor);
		}else{
	...
	public Double getRmbmoney() {
		return Double.valueOf(getBalancemoney().doubleValue() * getBalancerate().doubleValue() - (getNowBalanceRate().doubleValue() * getProtestFee().doubleValue()));
	}
