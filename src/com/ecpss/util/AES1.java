...
public class AES1 {
	...
	public static String getRawKey() {
		...
		try {
			...
			kgen.init(256); //  AES(256) bits may not be available
...
//	//秘钥进行第二层加密
	public static String getSha256(byte strData[]) {
		 String output = "";
	     try {
	       MessageDigest digest = MessageDigest.getInstance("SHA-256");
	       byte[] hash = digest.digest(strData);
...
//		System.out.println("Key = " + rawKey);
		 String a = "xingbill";
		// String b = getEncrypt(message, rawKey)
//
