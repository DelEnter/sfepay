...
public class JsonUtils
{
     ...
     * @param mainClass 主实体类�?
     * @param detailName 从实体类在主实体类中的属性名�?
     * @param detailClass 从实体类�?
     * @return
     */
     ...
     * 将JSON文本反序列化为主从关系的实体
     * @param <T>泛型T 代表主实体类�?
     * @param <D1>泛型D1 代表从实体类�?
     * @param <D2>泛型D2 代表从实体类�?
     * @param jsonString JSON文本
     * @param mainClass  主实体类�?
     * @param detailName1 从实体类在主实体类中的属�?
     * @param detailClass1 从实体类�?
     * @param detailName2 从实体类在主实体类中的属�?
     * @param detailClass2 从实体类�?
     * @return
     */
     ...
     * @param detailName2 从实体类在主实体类中的属�?
     * @param detailClass2 从实体类�?
     * @param detailName3 从实体类在主实体类中的属�?
     * @param detailClass3 从实体类�?
     * @return
     */
