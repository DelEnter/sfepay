					...
					<tr align=center>	
			   	   ...
			   	   <!--	<tr align=center>
			   	   	...
			   	   	<tr align=center>
			   	   		<td height=30>备注</td>
			   	   		<td>
<s:select name="trade.remark" id="remark" list="#{'':'','不接受':'不接受','查询卡中心':'查询卡中心','没收（黑卡）':'没收（黑卡）','不接纳此卡':'不接纳此卡','此卡已失效':'此卡已失效','卡过期':'卡过期','无此卡号':'无此卡号','卡号有误':'卡号有误','非法交易':'非法交易','商户要求取消':'商户要求取消','重复交易':'重复交易','被窃卡':'被窃卡','零金额':'零金额','TEST':'TEST'}"  listKey="key" listValue="value"/>
			   	   		</td>
			   	   	</tr>
			   	</TABLE>
