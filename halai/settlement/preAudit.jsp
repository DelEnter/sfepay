...
<SCRIPT language=JavaScript>
  ...
  <body>
  	<H3 align=center>预授权审核</H3>

    <s:form name="form1" id="form1" action="toauditPre" theme="simple" method="post" >
  		<table align="center">
  			<tr>
  				<td>商户号</td>
  				<td>
 ...
 <s:form name="form2" id="form2" action="toauditPre" theme="simple" method="post" >
	  ...
	  <tr>
	    <td width="24%"><input type="button" value="审核通过" onClick="check('1')"/> </td>
	    <td width="69%">&nbsp;</td>
	    <td width="3%">&nbsp;</td>
	    <td width="4%">&nbsp;</td>
	    </tr>
	  ...
	  <tr>
		...
		<td valign="top">
		  		...
		  		<input type="button" value="审核不通过" onClick="check('2')"/></td>
		<td>&nbsp;</td>
	</tr>
 	</table>
