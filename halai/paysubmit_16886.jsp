...
<body>
<form action="http://security.sslepay.com/sslpayment" method="post">
    <table align="center">
        ...
        <tr><td>MD5加密字符串</td>
         ...
         <tr><td>email</td>
            <td><input type="text" name="email" value="sales2@ecpss.com"></td></tr>            
         <tr><td>phone</td>
         ...
         <tr><td>shippingEmail</td>
            <td><input type="text" name="shippingEmail" value="sales2@ecpss.com"></td></tr>            
