...
<style>
.windows{ width:350px; height:auto; margin:0 0 0 25px;}
.left{ width:80px; height:30px; float:left;padding:3px 0 0 0}
.right{ width:200px; height:30px; float:left;  }
</style>
...
<div id="resizetable" width="400" height="320">
  <div class="windows">
