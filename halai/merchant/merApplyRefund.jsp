...
<p align="center">
	<font color="red">
	提醒：根据Sfepay交易流水号查询出该笔交易，填写退款金额进行申请退款
	<br/>
       ...
       <div class="list">
         ...
         <div class="listlist">
           <ul class="listlistbottom">
			 ...
			 <li class="lil_05"><s:property value="applyRefund.tradeTime" /></li>    
			 <li class="lil_04"><s:property value="applyRefund.tradeAmount" /></li>    
			 <li class="lil_03"><s:property value="states.getStateName(applyRefund.tradeState,1)" escape="false"/></li>  
			 <li class="lil_04"><s:property value="states.getStateName(applyRefund.tradeState,2)" escape="false"/></li>  
			 <li class="lil_03"><input type="input" name="refundAmount" id="refundAmount" class="text_input_01" style="color:red" title="Enter Refund Amount" value="<s:property value="applyRefund.tradeAmount" />"/></li>    
           </ul>
           
           <ul class="listlistpage">
             <li><font color="red"><s:property value="messageAction"/><br/></font>
	<input type="button" name="s" value="提交申请" class="input_button_01" onclick="applyRefund(<s:property value="applyRefund.tradeAmount" />)" /></li>
           </ul>
		   <br class="clear" />
