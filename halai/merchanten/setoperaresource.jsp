...
function setResource(f){
          var str='operatorResourEn.action?shopOpera.id='+f;
...
<div class="mainbody">
       ...
       <div class="list">
         <div class="listtitle">
           <ul class="top">
             <li class="lifonttitle">Operator List</li>
             <li class="lilistimg2"><input type="button" value="" onclick="adds();" class="addadmin" /></li>
           </ul>
           <ul class="bottom">
             <li class="li_11">User name</li>  
             <li class="li_09">Active</li>
           </ul>
         </div>
         <div class="listlist">
       <s:iterator id="listOne" value="opera" >
           <ul class="listlistbottom">
             ...
             <li class="lil_09"><input type="button" value="" title="Permissions configuration" class="button_edit_01" onclick="setResource('<s:property value='#listOne.id'/>');"  />
		<input type="button" value="" title="Delete" class="button_deltet_01" onclick="todeleteOpera('<s:property value='#listOne.id'/>');"  /></li>  
           </ul>
         </s:iterator>    
...
<!--<input type="button" value="Creating new Operator" onclick="add();" />
...
<div class="fate" >
 ...
 <s:form action="delOperatorEn" id="form1" namespace="/merchant">
