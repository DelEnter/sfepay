...
<head>
	<title>Merchant ChargeBack</title>
</head>
...
<!--头部end-->
<s:form name="formu" id="formu" action="merChargeBackQueryEn" method="post" theme="simple">
    ...
    <ul class="searchbutton">
      <li>
       ...
       <div class="list">
         <div class="listtitle">
           <ul class="top">
             <li class="lifonttitle">ChargeBack Trade</li>
          ...
          <li class="lilistimg"><a href="#" onclick="exportInfo()"><img src="images/download.gif" alt="下载交易" /></a></a></li>
           ...
           <ul class="bottom">
             ...
             <li class="li_12">Date</li> 
             <li class="li_03">ChargeBack</li>        
             <li class="li_05">Reason</li> 
             <li class="li_07">Operate</li> 
           </ul>
         </div>
         <div class="listlist">
         <s:iterator id="p" value="info.result" status="s">
           <ul class="listlistbottom">
			 ...
			 <li class="lil_03"><s:property value="states.getStateNameEn(#p[1].tradeState,3)" escape="false" /></li>  
			 <li class="lil_05"><s:property value="#p[0].remark" /></li>    
			 <li class="lil_07"><s:if test="#p[0].isChargeBack==0">
				<a href="#" onclick="totijiaoshensu(<s:property value="#p[0].id" />)">Appeal</a>
			</s:if>
