...
<s:if test="messageAction==null">
	<s:form action="merSubmitComEn" id="form1" namespace="/merchanten" method="POST" theme="simple" enctype="multipart/form-data">
		...
		<tr>
			...
			<table align="center" border=0 cellpadding=1 cellspacing=1
				...
				<tr class="bg_table02">
					...
					<div align="right"><font color="red">* </font>Please select file：</div>
					</td>
