...
<script type="text/javascript">
	function merMain(){
		var url ="merMainActionEn.action";
   ...
   <td valign="top">  
     ...
     <div class="right">
          ...
          <div class="right_text">
			<s:form action="huakuanHistoryActionEn.action" name="batchform" theme="simple" method="post">
			<table  width="43%" align=center border=0 >
				...
				<tr>
					...
					批次号: &nbsp;&nbsp; <input type="text" name="batchno" value="<s:property value='batchno'/>" /> </td>
				</tr>
				<tr>
					<td align=center colspan=2>
