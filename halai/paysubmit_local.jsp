...
<%
    ...
    ReturnURL = "http://localhost:8888/sfepay/payresult.jsp";
...
<body>
<form action="http://localhost:8888/sfepay/sslpayment" method="post">
    <table align="center">
    ...
    <a href="http://localhost:8888/ecpss/fastPayInterface?MerNo=1254">快捷支付</a>
    </p>
