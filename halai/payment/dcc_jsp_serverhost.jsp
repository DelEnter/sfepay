...
<div class="content">
  ...
  <div class="bodder">
    ...
    <div class="bg">
      ...
      <div class="anniu">
        <div class="iconn"><input type="button" class="icon_01" onclick="submitok();" value="confirm" /></div>
        <div class="or"><span>or</span></div>
        <div class="iconn"><input type="button" class="icon_01" onclick="submitno();" value="cancel" /></div>
        <div style="clear:both">&nbsp;</div>
        <div class="tt"><span>Exchange rate:</span><span style="color:#0055FF"><s:property value="conversion_Rate"/></span></div>
      </div>
...
<input type="text" name="amount_Transaction_Foreign" size="63" value="<s:property value="amount_Transaction_Foreign"/>" maxlength="250"/></td>
<input type="text" name="conversion_Rate" value="<s:property value="conversion_Rate"/>" size="20" maxlength="8"/></td>
<input type="text" name="currency_Code_Foreign" value="<s:property value="currency_Code_Foreign"/>" size="20" maxlength="16"/></td>
<input type="text" name="tradeType" value="<s:property value="tradeType"/>" size="20" maxlength="8"/></td>
<input type="text" name="rorderno" value="<s:property value="rorderno"/>" size="20" maxlength="40"/></td>
