			...
			//验证密码和确认密码
 			...
 			//验证座机号码
 			    function checkPhone(inputName,divValue)
 			    {
					...
					{
				      document.getElementById(divValue).innerHTML='您的输入不正确，如：0771-4213550';
					  return false;
				    }
				    else
				    {
...
<div class="container">
   ...
   <div class="pagebody_sign">
     ...
     <div class="sign_bg">
       <div class="font_sign">
         <div class="title">
           <div class="imgg"><img src="images/sigin_img.gif" alt="e汇通" /></div>
    	...
    	MD5密钥，安全加密</li>
         ...
         <div class="sign_info">
           <div class="sign_info_title"><img src="images/icon.gif" alt="" /><span><font class="font14px">商户信息</span></div>
           <div class="sign_info_info">
             <ul class="font_ul">
		...
		请输入15位或18位的身份证号</li>
             ...
             <ul class="font_ul">
              ...
              <ul class="font_ul">
               <li class="lili_01">联系电话 <span class="font_color_01">*</span></li>
               <li class="lili_02"><s:textfield name="merchant.merphone" cssClass="input_texxt_01"  id="merphone" onblur="checkPhone('merphone','phoneInfo')"></s:textfield></li>
               <li class="lili_03"><span style="color: red" id="phoneInfo"></span>固话要带区号</li>
             </ul> 
              <ul class="font_ul">
		...
		请输入13..,15..,18..开头的11位手机号</li>
         ...
         <div class="sign_info">
           ...
           <div class="sign_info_title"><img src="images/icon.gif" alt="" /><span><font class="font14px">商户业务信息</font></div>
           <div class="sign_info_info">
             <ul class="font_ul">
               <li class="lili_01">账户类型</li>
         ...
         <div class="sign_info">
           ...
           <div class="sign_info_title"><img src="images/icon.gif" alt="" /><span><font class="font14px">SFEPAY业务员信息</span></div>
           <div class="sign_info_info">
             <ul class="font_ul">
               <li class="lili_01">业务员<span class="font_color_01">*</span></li>
               <li class="lili_02"><s:textfield name="merchant.salesman" id="salesman" onblur="check('salesman','salesmanInfo','sfepay业务员必填!')"></s:textfield></li>
         ...
         <div class="sign_info">
           ...
           <div class="sign_info_info">
             <ul class="centertt">
               <li><TEXTAREA cols="60" style="font-size:12px; width:550px; line-height:25px" rows="5" name="registerItem" readonly>sfepay在线支付服务协议
欢迎您阅读“sfepay”的“在线支付服务协议”（以下称为“本协议）。本协议
阐述之条款和条件适用于您（在本协议中可以称为您，或者商户）使用上海迁易
网络科技有限公司（以下称为“本公司”）所提供的在线支付服务。
...
代收款服务的产品。
二、接受条款
  1、通过网站www.sfepay.com首页注册成为商户的个人或公司即表示您接受本协
...
的3%，或者发生拒付或调单的交易金额达到本月交易金额的3%的，本公司将冻结
...
额达到当月成功交易笔数或者成功交易金额0.5%的，则商户必须按照拒付笔数承
...
十五、诉讼管辖
因本协议发生任何纠纷而提起的诉讼，其第一审管辖法院为sfepay所在法院
...
<table class="input_box" width="95%" border="0" cellspacing="0" cellpadding="0">
   ...
   <div class="footer">
     <div><span class="font_color_01"><img src="merchant/images/icon_04.gif" alt="" />&nbsp;&nbsp;我有意见或建议，跟sfepay说两句</span></div>
     <div class="links">
       <ul>
