...
<%
    ...
    ReturnURL = "http://localhost:8888/halai/payresult.jsp";
...
<body>
<form action="http://localhost:8888/halai/sslpaymenttestnew" method="post">
    <table align="center">
        ...
        <tr><td>MD5加密字符串</td>
         ...
         <tr><td>listname</td>
            <td><input type="text" name="listname" value="listname"></td></tr>   
    ...
    <p align="center"><input type="submit" name="b1" value="支付">
     <a href="http://security.sslepay.com/fastPayInterface?MerNo=1685">快捷支付</a>
    </p>
